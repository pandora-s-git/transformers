...
def convert_tekken_tokenizer(tokenizer_file: str):
    ...
    tokenizer = LlamaTokenizerFast(
        tokenizer_object=MistralConverter(vocab=vocab, pattern=mc_tokenizer.instruct_tokenizer.tokenizer._model._pat_str, additional_special_tokens=all_special).converted(),
    )
